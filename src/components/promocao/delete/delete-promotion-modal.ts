...
@Component({
  selector: 'delete-promotion-dialog',
  templateUrl: 'delete-promotion-modal.html',
  styleUrl: 'delete-promotion-modal.scss',
  imports: [ 
    MatToolbarModule, 
    MatTableModule,  
    MatIcon, 
...
export class DeletePromotionDialog {
  ...
  readonly dialogRef = inject(MatDialogRef<DeletePromotionDialog>);
